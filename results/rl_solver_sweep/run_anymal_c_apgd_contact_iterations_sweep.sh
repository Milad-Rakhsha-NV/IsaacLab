#!/usr/bin/env bash
# Sequential Anymal-C APGD sweep over contact iterations at zero compliance.
set -uo pipefail
source ~/miniforge3/etc/profile.d/conda.sh
conda activate dvi
cd ~/repos/isaaclab-dvi
BASE="$(pwd)/results/rl_solver_sweep/raw/anymal_c"
MASTER="$BASE/apgd_contact_iterations_20_40_60_master.log"
for contact in 20 40 60; do
